...
class AccessibilityMetrics:
    ...
    @staticmethod
    def calculate_road_density(graph: nx.Graph, area_ha: float | None = None) -> float:
        """
    ...
    def calculate_intersection_density(
        graph: nx.Graph, area_ha: float | None = None
    ) -> float:
        """
...
class SpaceSyntaxMetrics:
    ...
    def calculate_all_metrics(
        self, graph: nx.Graph, area_ha: float | None = None
    ) -> dict[str, Any]:
        """
        全ての指標を計算
